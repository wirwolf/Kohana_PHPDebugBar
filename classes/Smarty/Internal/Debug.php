...
class Smarty_Internal_Debug extends Smarty_Internal_Data
{
	...
	public static function display_debug($obj)
	{
		...
		if ($obj instanceof Smarty_Internal_Template) {
			\DebugBar::instance()->Smarty->addData('template_name', $obj->source->type . ':' . $obj->source->name);
		}
		if ($obj instanceof Smarty) {
			\DebugBar::instance()->Smarty->addData('template_data', self::$template_data);
		} else {
			\DebugBar::instance()->Smarty->addData('template_data', null);
		}
		\DebugBar::instance()->Smarty->addData('assigned_vars', $_assigned_vars);
		\DebugBar::instance()->Smarty->addData('config_vars', $_config_vars);
		\DebugBar::instance()->Smarty->addData('execution_time', microtime(true) - $smarty->start_time);
	}
